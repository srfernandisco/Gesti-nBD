...
public class AyudanteBD extends Conexion {
	...
	private final static String INSERT_USER ="INSERT INTO USUARIOS "
			+ "(nombreUsuario, passwordUsuario,tipoUsuario) "
			+ "VALUES ( ?, PASSWORD(?),?)";
	
	private static final String DELETE_USUARIO = "DELETE FROM USUARIOS WHERE "
			+ "NOMBREUSUARIO=?";
    ...
    /**
     * Registra(alta) en la base de datos MySQL el usuario, guarda la contraseña hasheada y
     *  el tipo de usuario
     * 
     * @param usuario
     * @param passwd
	...
	public boolean registrarUsuario (Usuario usuario) 
	{
		...
		// Si se ha afectado una fila, filasAfectadas será igual a 1 y devolvemos true
	...
	public boolean borrarUsuario (Usuario usuario){
		...
		//como en el caso anterior pero en vez de insertar una fila borra una fila
		return (filasAfectadas==1);
